  ...
  return (
    <nav aria-label="Phân trang" className="flex items-center justify-center gap-2">
      <button
        ...
        className="flex h-[36px] w-[36px] items-center justify-center rounded-md border border-[#E4E1E0] text-[#5F5D5D] disabled:opacity-40"
      >
      ...
      {pages.map((p, i) =>
        p === "gap" ? (
          ...
          <button
            ...
            onClick={() => onChange(p)}
            className={`flex h-[36px] w-[36px] items-center justify-center rounded-md text-[13px] font-medium ${
