...
export function HomeSearchBar2({ locationOptions, propertyTypeOptions }: HomeSearchBar2Props) {
  ...
  return (
    <div className="rounded-lg border border-[#EDEBEA] bg-white p-4 min-[900px]:flex min-[900px]:items-end min-[900px]:gap-3 min-[900px]:p-5">
      <p className="mb-3 text-[15px] font-bold text-[#0C0D0D] min-[900px]:hidden">Tìm kiếm bất động sản</p>
      <div className="grid grid-cols-2 gap-3 min-[900px]:flex min-[900px]:flex-1 min-[900px]:gap-3">
        <label className="min-[900px]:flex-1">
      ...
      <label className="mt-3 block min-[900px]:mt-0 min-[900px]:flex-[1.4]">
