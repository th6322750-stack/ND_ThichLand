...
export const DEFAULT_ABOUT_PAGE_CONTENT: AboutPageContent = {
  ...
  statsDescription: "Thông tin có thể cập nhật khi có số liệu chính thức",
  stats: [
  ...
  areas: [
    { title: "Bất động sản cho thuê", description: "Nội dung chi tiết theo CMS.", image: "" },
    { title: "Dự án", description: "Nội dung chi tiết theo CMS.", image: "" },
    { title: "Tin tức & tư vấn", description: "Nội dung chi tiết theo CMS.", image: "" },
  ],
